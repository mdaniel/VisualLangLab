...
VisualLangLab is a completely visual IDE for development of parsers
without code or scripts of any kind. It is simple to use, and easy to learn.
A grammar is represented as a tree with distinct icons for grammar elements.
...
The licenses directory contains copyright files for other software used.