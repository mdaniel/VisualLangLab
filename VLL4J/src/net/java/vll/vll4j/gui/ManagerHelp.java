...
public class ManagerHelp {
    ...
    Action sampleTdarExpr = new AbstractAction("TDAR-Expr") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/TDAR-Expr.vll");
            gui.reset(false);
    ...
    Action sampleTdarExprActions = new AbstractAction("TDAR-Expr-Action") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/TDAR-Expr-Action.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
    ...
    Action sampleTdarExprAst = new AbstractAction("TDAR-Expr-AST") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/TDAR-Expr-AST.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
    ...
    Action sampleTdarSimpleTreeInterpreter = new AbstractAction("TDAR-Simple-Tree-Based-Interpreter") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/TDAR-Simple-Tree-Based-Interpreter.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
    ...
    Action samplePs2eArithExpr = new AbstractAction("PS2E-ArithExpr") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/PS2E-ArithExpr.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
    ...
    Action samplePs2eSimpleJson = new AbstractAction("PS2E-SimpleJSON") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/PS2E-SimpleJSON.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
    ...
    Action samplePs2eArithExprAction = new AbstractAction("PS2E-ArithExpr-Action") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/PS2E-ArithExpr-Action.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
    ...
    Action samplePswpPayrollParserCombinators = new AbstractAction("PSWP-Payroll-Parser-Combinators") {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            InputStream is = ClassLoader.getSystemClassLoader().
                    getResourceAsStream("net/java/vll/vll4j/gui/resources/PSWP-Payroll-Parser-Combinators.vll");
            gui.reset(false);
            gui.theFileManager.openInputStream(is, false);
